...
export default function MachinesTable({
  ...
  const filteredMachines = useMemo(() => {
    ...
    return machines.filter((machine) => {
      ...
      const matchesStatus =
        statusFilter === null || currentActive === statusFilter

      const matchesCategory =
        categoryFilters.size === 0 || categoryFilters.has(machine.category)
              ...
              {COLUMNS.map((col) => {
                ...
                return (
                  <th
                    ...
                    className={cn(
                      'h-11 px-3',
                      'bg-primary-100 font-sans text-xs font-medium whitespace-nowrap text-neutral-600 text-left',
                      col.minWidth
                    )}
                  >
                    <button
